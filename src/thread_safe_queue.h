...
namespace network {
    ...
    public:
        // initially only one ThreadSafeQueue should create data that afterwords will be used in
        // others ThreadSafeQueue. Only that object of ThreadSafeQueue should have
        // isPrimaryQueue=true
        /**
         * @brief Constructor
         */
